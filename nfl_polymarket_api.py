...
class NFLPolymarketAPI:
    def __init__(self):
        self.BASE_URL = "https://gamma-api.polymarket.com"
        self.NFL_SERIES_ID = "10187"  # NFL series ID from Polymarket
    ...
    def get_nfl_games(self):
        ...
        try:
            ...
            print(f"Error fetching NFL games from Polymarket: {e}")
            return []
